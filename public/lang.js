...
(function () {
  ...
  var DICT = {
    ro: {
      ...
      /* ── Pagina despre ───────────────────────────── */
      'despre.h1':                'Despre mine și acest site',
      'despre.bc':                'Despre',
      'despre.intro-html':        'Mă numesc Lucian, am 42 de ani și mă lupt cu greutatea de când mă știu.',
      'despre.h2-copilarie':      'Copilărie și liceu',
      'despre.p-copilarie':       'În copilărie am fost supraponderal. În primul an de liceu s-a întâmplat ceva cu corpul meu — m-am înălțat și am slăbit într-un interval scurt. Din copilul supraponderal care termina clasa a 8-a am devenit un adolescent înalt și suplu în clasa a 9-a, ajungând la aproximativ 70 kg la 1,79 m, și am rămas așa pe toată perioada liceului.',
      'despre.h2-facultate':      'Primul an de facultate',
      'despre.p-facultate':       'Dar în primul an de facultate avea să se întâmple ceva ce urma să îmi schimbe calitatea vieții în rău. Am luat în greutate 35 kg în aproximativ 2 luni. Și-am continuat așa nici mai mult nici mai puțin de vreo 20 de ani, timp în care nu doar că nu am reușit să slăbesc, dar am mai și acumulat în greutate până la 121 kg.',
      'despre.p-facultate-2':     'Cum am lăsat să treacă atâta timp fără să fac nimic? La început credeam că e ceva de moment, că așa cum m-am îngrășat o să și slăbesc. Apoi, odată cu trecerea timpului, am început să pretind că nu e chiar așa deranjant.',
      'despre.h2-diabet':         'Diagnosticul',
      'despre.p-diabet':          'Dar toate aceste alibiuri pe care mi le-am creat în subconștient și-au pierdut argumentele când am fost diagnosticat de curând cu tensiune arterială și diabet de tip II. Eu care credeam că nu mi se poate întâmpla nimic deosebit, că tot timpul lucrurile astea li se întâmplă celorlalți, am înțeles brusc că această nouă condiție medicală în care mă aflu mă pune în antiteză cu responsabilitatea pe care o am față de cei doi copii minori care mă așteaptă zilnic acasă. Așa că am hotărât că e timpul să fac ceva începând de ACUM... nu de luni, nu de la 1 ianuarie 😄',
      'despre.h2-schimbare':      'Ce s-a schimbat',
      'despre.p-schimbare':       'Am urmat diverse programe cu nutriționiști, dar niciunul nu s-a potrivit cu ritmul meu de viață și cu natura jobului meu. Fiecare plan părea construit pentru altcineva. În cele din urmă am început să mă documentez temeinic pe cont propriu. Am eliminat treptat alimentele dăunătoare și le-am înlocuit cu altele mai sănătoase. Consum alcool doar ocazional, cu precădere vin, și foarte rar bere. Evit pe cât pot mâncărurile prăjite, zahărul și pâinea albă — am trecut pe pâine de secară, graham și grâu integral. Am eliminat complet sucurile îndulcite și carbogazoase. Încerc să mănânc ultima masă a zilei cel târziu la 19:30. Rezultatul: 12 kilograme slăbite într-o lună și jumătate.',
      'despre.h2-site':           'De ce există acest site',
      'despre.p-site':            'Am creat Slăbește Ușor pentru a centraliza tot ce am reușit să documentez despre diete și alimentație sănătoasă. Sper ca altcineva aflat în situația în care am fost eu să nu fie nevoit să parcurgă toate încercările nereusite prin care am trecut — și să scurteze pașii către ceea ce i se potrivește cu adevărat.',
      'despre.h2-abordare':       'Abordarea site-ului',
      'despre.p-abordare-html':   'Nu am nicio calificare în domeniul medical și nu mă prezint ca atare. Prezint informațiile <strong>neutru și factual</strong>: cum funcționează fiecare dietă, ce mănânci, ce eviți, avantaje, dezavantaje și contraindicații. Nu promovez nicio dietă anume și nu vând programe. Scopul e să poți compara și să decizi singur — ideal împreună cu un specialist.',
      'despre.p-disclaimer-html': 'Conținutul are scop pur informativ și nu înlocuiește consultul medical. Vezi <a href="/disclaimer-medical/">disclaimerul medical</a>.',
      'despre.p-contact-html':    'Ai o sugestie sau o corectură? <a href="/contact/">Scrie-mi</a>.',
      /* ── Pagina vedete ───────────────────────────── */
    ...
    en: {
      ...
      /* ── Pagina despre ───────────────────────────── */
      'despre.h1':                'About me and this site',
      'despre.bc':                'About',
      'despre.intro-html':        'My name is Lucian, I am 42 years old and I have been struggling with my weight for as long as I can remember.',
      'despre.h2-copilarie':      'Childhood and high school',
      'despre.p-copilarie':       'I was overweight as a child. In my first year of high school something changed with my body — I grew taller and lost weight in a short space of time. From the overweight kid finishing 8th grade I became a tall, slim teenager in 9th grade, reaching around 70 kg at 1.79 m, and I stayed that way throughout high school.',
      'despre.h2-facultate':      'First year of university',
      'despre.p-facultate':       'But in my first year of university something happened that was about to change my quality of life for the worse. I gained 35 kg in approximately 2 months. And I carried on like that for no less than 20 years, during which I not only failed to lose the weight but kept gaining until I reached 121 kg.',
      'despre.p-facultate-2':     'How did I let so much time go by without doing anything? At first I thought it was temporary — that just as I had put the weight on, I would lose it again. Then, as time passed, I started pretending it was not really that bad.',
      'despre.h2-diabet':         'The diagnosis',
      'despre.p-diabet':          'But all those excuses I had built up in my subconscious lost their hold when I was recently diagnosed with high blood pressure and type 2 diabetes. I, who had always believed nothing serious could happen to me — that these things only happened to other people — suddenly understood that this new medical condition put me at odds with the responsibility I have towards my two young children who wait for me at home every day. So I decided it was time to do something starting NOW... not on Monday, not on January 1st 😄',
      'despre.h2-schimbare':      'What changed',
      'despre.p-schimbare':       'I followed various programmes with nutritionists, but none of them suited my lifestyle or the demands of my job. Every plan seemed designed for someone else. Eventually I started doing thorough research on my own. I gradually cut out the foods that were harming me and replaced them with healthier alternatives. I drink alcohol only occasionally — mostly wine and very rarely beer. I avoid fried food, sugar and white bread as much as I can, and I have switched to rye, graham and wholegrain bread. I have cut out sweetened and fizzy drinks entirely. I try to have my last meal of the day no later than 19:30. The result: 12 kilograms lost in a month and a half.',
      'despre.h2-site':           'Why this site exists',
      'despre.p-site':            'I created Slăbește Ușor to bring together everything I have managed to research about diets and healthy eating. My hope is that someone in the situation I was once in will not have to go through all the failed attempts I went through — and can instead take a shortcut to finding what truly works for them.',
      'despre.h2-abordare':       'The site\'s approach',
      'despre.p-abordare-html':   'I have no medical qualifications and I do not claim to have any. I present information <strong>neutrally and factually</strong>: how each diet works, what you eat, what you avoid, pros, cons and contraindications. I do not promote any particular diet and I do not sell programmes. The goal is for you to compare and decide for yourself — ideally together with a specialist.',
      'despre.p-disclaimer-html': 'Content is for informational purposes only and does not replace medical advice. See the <a href="/disclaimer-medical/">medical disclaimer</a>.',
      'despre.p-contact-html':    'Have a suggestion or correction? <a href="/contact/">Write to me</a>.',
      /* ── Pagina vedete ───────────────────────────── */
